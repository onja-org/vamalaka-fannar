...
export const CATEGORIES_DROP_DOWN_OPTIONS = [
  { label: CATEGORIES_NAMES.HANDCRAFT, value: CATEGORIES_VALUES.HANDCRAFT },
  { label: CATEGORIES_NAMES.FOOD, value: CATEGORIES_VALUES.FOOD },
